...
public class PlayBillMangerTest {
    ...
    void shouldAddOneMovie() {
        PlayBillManager playBillManger = new PlayBillManager();
    ...
    void shouldFindLastMoviesMoreNumShow() {
        ...
        Repository repo = new Repository(5);
        PlayBillManager playBillManger = new PlayBillManager(repo);
        playBillManger.addMovie(movie1);
        playBillManger.addMovie(movie2);
        playBillManger.addMovie(movie3);
        playBillManger.addMovie(movie4);
    ...
    void shouldFindLastMoviesLessNumShowDefault() {
        Movie[] expected = new Movie[]{movie4, movie3, movie2, movie1};
        Repository repo1 = new Repository(5);
        PlayBillManager playBillManger = new PlayBillManager(repo1);
        playBillManger.addMovie(movie1);
        playBillManger.addMovie(movie2);
        playBillManger.addMovie(movie3);
        playBillManger.addMovie(movie4);
